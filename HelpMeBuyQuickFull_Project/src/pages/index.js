...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-500 p-4 flex flex-col justify-between">
      <div>
      ...
      <footer className="text-center text-white mt-12 py-4">
        <p>Connect with us:</p>
        ...
        <p className="mt-2 text-sm">&copy; 2025 HelpMeBuyQuick. All rights reserved.</p>
      </footer>
    </div>
  );
}
